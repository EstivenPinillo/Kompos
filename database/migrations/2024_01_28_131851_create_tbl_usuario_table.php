...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tbl_usuario', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('fk_tp_dcmnt');
            $table->foreign('fk_tp_dcmnt')->references('id_tp_dcmnt')->on('tbl_tipo_documento');
            ...
            $table->timestamps();
            $table->index(['id_usuario','fk_perfil','fk_tp_dcmnt','fk_estado']);
        });
    }
